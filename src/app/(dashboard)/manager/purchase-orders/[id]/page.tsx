...
export default function ManagerPurchaseOrderDetailPage() {
    ...
    const handleAction = async (action: string) => {
        if (!confirm(`Yakin ingin ${action} PO ini?`)) return
                    ...
                    <CardContent className="space-y-2">
                        ...
                        {po.supplier.phone && (
                            <div>
                                ...
                                <div className="font-medium">{po.supplier.phone}</div>
                            </div>
                        )}
                    </CardContent>
                </Card>
                            ...
                            <tbody>
                                {po.items.map((item) => (
                                    <tr key={item.id} className="border-b">
                                        ...
                                        <td className="p-3 text-sm text-muted-foreground">{item.product.sku}</td>
                                ...
                                <tr>
                                    ...
                                    <td className="p-3 text-right text-xl font-bold text-primary">
